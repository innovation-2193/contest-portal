...
CREATE TABLE IF NOT EXISTS registrations (
  ...
  participant_role VARCHAR(32) NOT NULL DEFAULT 'Guest',
  ...
  checked_in_by_email VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS submissions (
  ...
  review_rules_score DECIMAL(5,2) UNSIGNED NULL,
  review_problem_score DECIMAL(5,2) UNSIGNED NULL,
  review_innovation_score DECIMAL(5,2) UNSIGNED NULL,
  review_evidence_score DECIMAL(5,2) UNSIGNED NULL,
  review_impact_score DECIMAL(5,2) UNSIGNED NULL,
  review_total_score DECIMAL(5,2) UNSIGNED NULL,
