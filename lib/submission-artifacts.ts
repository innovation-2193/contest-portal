...
function confirmationHtml(record: SubmissionEmailRecord) {
  ...
  return brandedEmailHtml({
    ...
    content: `<p style="margin:0 0 18px">เรียน ${escapeHtml(recipientName)}</p>
        ...
        <a href="${escapeHtml(detailUrl)}" style="display:inline-block;background:#d8b62f;color:#07142b;text-decoration:none;font-weight:700;padding:13px 22px;border-radius:9px">เข้าสู่ระบบเพื่อดูผลงาน</a>
      `,
  });
}
