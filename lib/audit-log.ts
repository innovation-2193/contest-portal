...
const allowedAuditActions = new Set([
  ...
  "submission.committee_score_form_pdf",
  "submission.committee_score_form_zip",
  "submission.committee_score_form_custom_pdf",
  "committee_score.total_submitted",
  "committee_score.total_updated",
  "committee_score.total_deleted",
  ...
  "presentation_score.report_version_deleted",
  ...
  "committee_score.scoreboard_details_pdf",
  ...
  "winner.created",
  "winner.deleted",
  "winner.team_participants_synced",
  "winner.export_pdf",
