export const adminNoticeMessages = {
  ...
  non_finalists_registered: "ลงทะเบียนผู้ประกวดที่เลือกเข้าร่วมงานเรียบร้อยแล้ว",
  ...
  participant_checkin_none_selected: "ยังไม่ได้เลือกรายการผู้เข้าร่วมงานสำหรับเช็คอิน",
  participants_checked_in: "เช็คอินผู้เข้าร่วมงานที่เลือกเรียบร้อยแล้ว",
