  ...
  <head>
    ...
    <style>
      ...
      @media only screen and (max-width: 480px) {
        ...
        .email-header-title { font-size: 24px !important; line-height: 1.35 !important; }
      ...
      <tr>
        <td class="email-outer-pad" align="center" style="padding:24px 12px">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:680px;background:#ffffff;border:1px solid #d8b62f;border-radius:14px;overflow:hidden">
            ...
            <tr>
              <td class="email-content" style="padding:28px 30px;font-size:16px;color:#172033;background:#ffffff">
                ${content}
              </td>
            </tr>
            <tr>
              <td class="email-footer" style="padding:18px 30px;background:#f5f7fb;border-top:1px solid #e2e7ef;font-size:13px;line-height:1.7;color:#5a6478">
