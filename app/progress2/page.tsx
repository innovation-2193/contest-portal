    ...
    <div className="wide">
      <div className="admin-topline progress1-topline">
        <div>
          ...
          <p>แสดงเฉพาะสถานะตรวจ ไม่มีคะแนน ไม่มี comments และไม่มีไฟล์ดาวน์โหลดในหน้านี้</p>
        </div>
      ...
      <section className="admin-panel progress1-reviewer-panel">
        <header className="admin-section-head">
          ...
          <div>
            ...
            <p>สถานะในตารางนี้มีเพียงตรวจแล้วและยังไม่ตรวจ</p>
          </div>
        </header>
        ...
        <div className="admin-table-wrap progress2-table-wrap">
          <table className="admin-table compact-admin-table progress2-table">
            ...
            <tbody>{visibleSubmissions.length ? visibleSubmissions.map((item) => <tr key={item.submission_code}>
