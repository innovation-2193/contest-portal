...
import { ArrowLeft, CheckCircle2, Clock3, Eye, FileSpreadsheet, FileText, Gauge, RefreshCw, ShieldCheck, Star, Trophy, UserCheck, UsersRound } from "lucide-react";
    ...
    <div className="wide">
      <div className="admin-topline progress1-topline">
        ...
        <div className="admin-actions">
          ...
          <a className="secondary" href="/api/progress1/export/pdf"><FileText/>Export PDF รายงานผู้ตรวจ</a>
