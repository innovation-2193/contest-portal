...
const templateRows = [
  ["คำนำหน้า", "ชื่อ", "นามสกุล", "Role ผู้เข้าร่วม", "ตำแหน่ง", "สังกัด / กองบังคับการ", "กองบัญชาการ / ชื่อหน่วยงาน / หน่วยจัดบูธ", "อีเมล", "เบอร์โทร"],
  ["นาย", "สมชาย", "ใจดี", "Guest", "เจ้าหน้าที่ประสานงาน", "ฝ่ายอำนวยการ", "สำนักงานตำรวจแห่งชาติ", "somchai@example.com", "0891111111"],
  ["นางสาว", "พรทิพย์", "ตั้งใจ", "Exhibitor", "", "", "สถาบันเทคโนโลยีป้องกันประเทศ", "porntip@example.com", "0812222222"],
  ["", "กรอกเฉพาะชื่อก็ได้", "", "", "", "", "", "", ""],
