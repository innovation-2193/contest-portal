...
export function PresentationScorePanel() {
  ...
  return <section className="admin-panel committee-score-import-panel presentation-score-panel" id="presentation-score-form2">
    ...
    <div className="committee-score-actions"><a className="primary" href="/api/admin/presentation-scores/form"><FileText/>Export PDF แบบฟอร์มกรอกคะแนนรอบที่ 2</a><a className="secondary" href="/api/admin/presentation-scores/report"><FileText/>Export PDF Report คะแนนถ่วงน้ำหนัก</a><a className="secondary" href="/api/admin/presentation-scores/template"><Download/>ดาวน์โหลด Template คะแนนรอบที่ 2</a><label className="secondary committee-upload-button"><Upload/>อัปโหลดคะแนนรอบที่ 2<input type="file" accept=".xlsx,.csv" onChange={importScores} disabled={working || loading}/></label></div>
